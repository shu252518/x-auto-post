...
「1日1古典｜仕事と人間関係に効く知恵」を軸に、貞観政要、論語、孫子、韓非子、菜根譚、老子、荘子、孟子、大学、中庸、君主論、自省録を自分の言葉で要約し、現代の仕事・組織・人間関係へ応用します。原文や現代訳の転載、架空の引用・出典は行いません。朝・昼・夜で短い知恵、職場の具体例、深い問いを使い分け、品質はHook30・学び25・応用20・具体性15・自然さ10で採点します（75点未満は最大3回再生成）。
